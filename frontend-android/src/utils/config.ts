...
export const WEBSOCKET_CONFIG = {
  ...
  DEV: {
    WS_URL: 'http://43.201.141.164:8080/ws', // Android 에뮬레이터용 (http 사용)
    API_URL: 'http://43.201.141.164:8080/api',
  },
  // iOS 시뮬레이터용
  DEV_IOS: {
    WS_URL: 'http://43.201.141.164:8080/ws', // iOS 시뮬레이터용 (http 사용)
    API_URL: 'http://43.201.141.164:8080/api',
  },
  // 실제 디바이스용 (서버 IP 주소로 변경 필요)
  DEV_DEVICE: {
    WS_URL: 'http://43.201.141.164:8080/ws', // 실제 서버 IP로 변경 (http 사용)
    API_URL: 'http://43.201.141.164:8080/api',
  },
  // 스테이징 환경
  STAGING: {
    WS_URL: 'http://43.201.141.164:8080/ws',
    API_URL: 'http://43.201.141.164:8080/api',
  },
  // 프로덕션 환경
  PRODUCTION: {
